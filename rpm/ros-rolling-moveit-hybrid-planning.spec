...
%global pkg_name moveit_hybrid_planning
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-moveit-hybrid-planning
Version:        2.9.0
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 MoveIt Release Team <moveit_releasers@googlegroups.com> - 2.9.0-2
