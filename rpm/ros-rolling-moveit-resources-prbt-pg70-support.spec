...
%global pkg_name moveit_resources_prbt_pg70_support
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-moveit-resources-prbt-pg70-support
Version:        2.9.0
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Alexander Gutenkunst <a.gutenkunst@pilz.de> - 2.9.0-2
