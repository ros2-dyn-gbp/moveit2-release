...
%global pkg_name moveit_ros_occupancy_map_monitor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-moveit-ros-occupancy-map-monitor
Version:        2.9.0
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Henning Kayser <henningkayser@picknik.ai> - 2.9.0-2
