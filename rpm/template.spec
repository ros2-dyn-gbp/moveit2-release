...
%global pkg_name pilz_industrial_motion_planner_testutils
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-pilz-industrial-motion-planner-testutils
Version:        2.9.0
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Christian Henkel <c.henkel@pilz.de> - 2.9.0-2
